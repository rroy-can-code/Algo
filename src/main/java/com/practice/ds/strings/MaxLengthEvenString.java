...
public class MaxLengthEvenString {
	...
	public static void main(String... a) {
		...
		System.out.println("MaxLenEvenString  " + findMaxLenEven(str) + "  andLength of MaxLenEvenString    " + " "
				+ findMaxLenEvenString(str));
		sc.close();
	}
	...
	private static int findMaxLenEvenString(String str) {
		int currLen = 0, maxLen = 0, i = 0;
		// To store starting index of maximum
		// length word.
		while (i < str.length()) {
